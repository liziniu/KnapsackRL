...
EXP_NAME='a100_Knapsack-GRPO-Qwen2.5-Math-7B-DAPO_17K'
...
python3 -m verl.trainer.main_ppo \
    ...
    +trainer.allocation.min_n=${MIN_N} \
    +trainer.allocation.negative_n=${NEGATIVE_N} \
    +trainer.allocation.positive_n=${POSITIVE_N} \
    +trainer.allocation.max_n=${MAX_N} \
