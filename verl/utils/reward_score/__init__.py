...
def default_compute_score(
    ...
    if data_source == "openai/gsm8k":
    ...
    elif data_source in ["AIME", "AIME2025", "AMC", "MATH", "MINERVA", "OLYMPIAD_BENCH", "deepscaler", "Maxwell-Jia/AIME_2024"]:
        from rllm.rewards.math_reward import rllm_reward_fn_math

        res = rllm_reward_fn_math(data_source, solution_str, ground_truth)
        if return_pred:
            ...
            res = {
                ...
                "pred": pred if pred else str("[INVALID]"),
            }
        ...
        from recipe.r1.tasks.livecodebench import compute_score
