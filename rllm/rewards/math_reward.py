    ...
    def __call__(self, input: RewardInput) -> RewardOutput:
        ...
        if self.config.use_math_orm:
            try:
                ...
                print(f"There is an error in importing the call_gemini_llm and call_oai_rm_llm function. Error: {e}")
                raise e
...
def compute_score(data_source: str, solution_str: str, ground_truth: Union[str, List[str]], extra_info={}, prompt_str: str = None):
    return rllm_reward_fn_math(data_source, solution_str, ground_truth, extra_info)
